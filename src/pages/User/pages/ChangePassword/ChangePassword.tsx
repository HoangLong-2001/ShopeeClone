...
import type { IResponse, UserFormState } from '~/types/common.type'
import { userSchema } from '~/utils/rules'
import { isAxiosUnprocessableEntityError } from '~/utils/utils'
type FormData = Pick<UserFormState, 'password' | 'new_password' | 'confirm_password'>
...
export default function ChangePassword() {
  const {
    ...
    resolver: yupResolver(passwordSchema) as Resolver<FormData, any, FormData>
  })
  ...
  const onSubmit = handleSubmit(async (data) => {
    try {
      ...
      if (isAxiosUnprocessableEntityError<IResponse<FormData>>(error)) {
