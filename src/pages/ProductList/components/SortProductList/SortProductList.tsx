      ...
      <div className='flex flex-wrap items-center justify-between gap-2'>
        <div className='flex flex-wrap items-center gap-2'>
          ...
          >
            ...
            <option value={orderConst.asc} className='bg-white text-black'>
              {t('sortProductList.priceLowToHigh')}
            </option>
            <option value={orderConst.desc} className='bg-white text-black'>
              {t('sortProductList.priceHighToLow')}
            </option>
          </select>
        </div>
        ...
        <div className='flex items-center'>
          ...
          <div className='ml-2 flex'>
            ...
            {page === pageSize ? (
              <span className='flex h-8 w-9 items-center justify-center rounded-br-sm rounded-tr-sm bg-white px-3 shadow hover:bg-slate-100'>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  fill='none'
                  viewBox='0 0 24 24'
